const projectsSlides = document.querySelectorAll(".case-card");
...
function getImagePathByIndex(index) {
  const imagePaths = [
    "./assets/images/sections/section-cases/case-img-one.png",
    "./assets/images/sections/section-cases/case-img-two.png",
    "./assets/images/sections/section-cases/case-img-one.png",
  ];
