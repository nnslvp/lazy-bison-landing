...
const caseStudyPageWrapper = document.querySelector(
  ".case-study-page__wrapper"
);
...
const LINK_SET_LANG_EN = document.querySelectorAll(".set-lang-en");
const LINK_SET_LANG_PL = document.querySelectorAll(".set-lang-pl");
...
LINK_SET_LANG_PL.forEach((linkEl) => {
  linkEl.addEventListener("click", (e) => {
    setUserLanguage("pl");
  });
});
